...
// Query for fetching homepage with status (draft/published)
export const GET_HOMEDATA_WITH_STATUS = gql`
  query Homepage($status: PublicationStatus) {
...
// Keep old query for backwards compatibility
